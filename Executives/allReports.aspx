<%@ Page Title="" Language="C#" MasterPageFile="~/ui/mp/site.master" AutoEventWireup="true"
    CodeFile="allReports.aspx.cs" Inherits="Executives_allReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="float:left;">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            ForeColor="#333333" GridLines="None" Width="600px" DataKeyNames="ReportId">
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="ReportId" DataNavigateUrlFormatString="~/Member/Default.aspx?id={0}"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="reportsForCategory"
            SortParameterName="sort" TypeName="ReportManager" DeleteMethod="deleteReport">
            <DeleteParameters>
                <asp:Parameter Name="ReportId" Type="Int32" />
            </DeleteParameters>
            <SelectParameters>
                <asp:QueryStringParameter Name="Category" QueryStringField="sort" Type="String" />
                <asp:Parameter Name="sort" Type="String" />
                <asp:Parameter DefaultValue="Executive" Name="role" Type="String" />
            </SelectParameters>
